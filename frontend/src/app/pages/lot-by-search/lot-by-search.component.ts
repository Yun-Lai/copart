...
@Component({
  selector: 'app-lot-by-search',
  templateUrl: './lot-by-search.component.html',
  styleUrls: ['./lot-by-search.component.scss']
})
export class LotBySearchComponent implements OnInit {
