...
class VehicleInfo(models.Model):
    ...
    def to_json(self):
        return {
            ...
            "avatar": self.avatar,
            "source": self.source,
            "doc_type_ts": self.doc_type_ts,
            "doc_type_stt": self.doc_type_stt,
            "doc_type_td": self.doc_type_td,
            "odometer_orr": self.odometer_orr,
            "odometer_ord": self.odometer_ord,
            "lot_highlights": self.lot_highlights,
            "lot_seller": self.lot_seller,
            "lot_1st_damage": self.lot_1st_damage,
            "lot_2nd_damage": self.lot_2nd_damage,
            ...
            "grid": self.grid,
            "images": self.images,
            "thumb_images": self.thumb_images
        }
...
class Vehicle(models.Model):
    ...
    def to_json(self):
        return {
            ...
            "buy_today_bid": self.buy_today_bid,
